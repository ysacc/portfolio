      ...
      <section className="container section campus-grid">
        ...
        <div className="campus-panel">
          ...
          <ul className="plain-list">
            <li>
              Editor principal:{" "}
              <Link href="/guias/instalar-vscode">VS Code</Link>.
            </li>
            <li>
              Control de versiones:{" "}
              <Link href="/guias/instalar-git">Git</Link> + GitHub.
            </li>
            <li>
              Entorno JavaScript:{" "}
              <Link href="/guias/instalar-node">Node.js</Link> + npm.
            </li>
            <li>
              Testing y consumo de APIs:{" "}
              <Link href="/guias/instalar-postman">Postman</Link>.
            </li>
            <li>Terminal: PowerShell / Windows Terminal.</li>
            <li>
              Contenedores:{" "}
              <Link href="/guias/instalar-docker">Docker</Link> para Full
              Stack.
            </li>
          </ul>
        </div>
