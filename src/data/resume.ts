...
export const resumeData = {
    summary: "Senior Front-End Developer with over 7 years of experience developing modern, scalable, and user-centric web applications. Specialized in React.js, Next.js, and TypeScript, with a strong focus on componentization, design systems, performance, and maintainability. I have worked on high-demand enterprise and banking platforms (BBVA, Interbank, SANNA), collaborating closely with backend teams for the efficient integration of REST APIs and cloud services. I have complementary experience in Node.js and AWS, allowing me to provide a Full Stack perspective while maintaining a primary focus on Front-End.",
    experience: [
        {
            company: "Entelgy",
            role: "Senior Front-End Developer",
            period: "04/2024 – 12/2025",
            description: "Front-End interface development for investment and customer management banking platforms (BBVA, Interbank).",
            highlights: [
        ...
        },
        {
            ...
            description: "Web and mobile interface development for a real-time risk monitoring and control platform.",
            highlights: [
        ...
        },
        {
            ...
            description: "Internal web application development for Laureate Education / UTP.",
            highlights: [
        ...
        },
        {
            ...
            description: "Development of the internal academic management system for the Universidad Tecnológica del Perú.",
            highlights: [
        ...
        },
        {
            ...
            description: "Web platform development and maintenance for Pacífico / SANNA.",
            highlights: [
        ...
        },
        {
            ...
            description: "Involved in the Front-End development of a corporate ERP for Supermercados Peruanos.",
            highlights: [
    ...
    skills: {
        frontend: ["React.js", "Next.js", "TypeScript", "Vue.js", "TailwindCSS", "Design Systems"],
